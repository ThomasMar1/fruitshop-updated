    ...
    public partial class Manytomany : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dSupplierFruit", x => new { x.supplierId, x.fruitId });
                    table.ForeignKey(
                        name: "FK_dSupplierFruit_dFruit_fruitId",
                        column: x => x.fruitId,
                        principalTable: "dFruit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_dSupplierFruit_dSuppliers_supplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dSupplierFruit_fruitId",
